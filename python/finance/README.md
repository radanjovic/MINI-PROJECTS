...
Simple finance app made with Flask for the purpose of passing CS50x programming course by Harvard. This app uses external finance API to get data about particular stocks, and allows users to browse, buy and sell stocks.
